...
def school_list_school_courses(
    *,
    ...
    school_courses = school.school_courses.select_related("school").order_by("start_date")  # type: ignore[attr-defined]  # app démo hors INSTALLED_APPS : django-stubs ne génère pas le related manager
